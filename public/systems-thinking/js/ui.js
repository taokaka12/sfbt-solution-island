...
(function () {
  ...
  const ACHIEVEMENTS = [
    { id: 'first_lesson', icon: '🎓', name: '初入系统', desc: '完成第一节课', check: u => u.lessonsCompleted >= 1 },
    { id: 'five_lessons', icon: '📚', name: '小书虫', desc: '完成 5 节课', check: u => u.lessonsCompleted >= 5 },
    { id: 'twenty_five', icon: '📖', name: '系统学者', desc: '完成 25 节课', check: u => u.lessonsCompleted >= 25 },
    { id: 'chapter_complete', icon: '🏁', name: '单元终结者', desc: '完成第一个完整单元（章）', check: u => fullChapters(u).length >= 1 },
    { id: 'half_book', icon: '📗', name: '半程之美', desc: '完成全书一半的单元', check: u => fullChapters(u).length >= 4 },
    ...
    { id: 'streak_30', icon: '🌋', name: '系统大师', desc: '连续打卡 30 天', check: u => u.bestStreak >= 30 },
    ...
    { id: 'full_book', icon: '👑', name: '系统之王', desc: '完成全书的每一个小节', check: u => fullChapters(u).length >= 8 },
  ];
